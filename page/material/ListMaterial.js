layui.use(['form', 'layer', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'groupId', title: '分组名称', minWidth: 180, width: 230, align: "center"},
            {
                    ...
                    success: function (result) {
                        if (result.code === 0) {
                            ...
                            setTimeout(function () {
                                ...
                                window.location.href = "ListMaterial.html"
                            }, 500);
                        } else {
    ...
    $(document).on('click', '.material', function () {
        ...
        if (type === "图片") {
            ...
            redirect = '<div style="display: flex;justify-content: center;width: 100%;height: 100%;align-items: center;">' +
                '<video class="layui-upload-img thumbImg" src="' + data + '" controls id="perivew" width="600" height="400"></video></div>';
            type2 = 1;
            area = ['650px', '500px'];
        } else if (type === "直播") {
            redirect = "./page/util/video.html";
